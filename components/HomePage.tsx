...
const HomePage = () => {
  ...
  return (
    <>
      <div className="w-full bg-black px-5 lg:px-20 pt-[123px] pb-24">
        <div className="w-full items-center">
          <h1 className="text-center text-2xl lg:text-[56px] font-bold text-white lg:leading-[72.8px]">
            We are a collective of strategists, storytellers and creators driven
          ...
          <p className="text-center text-base lg:text-xl text-custom-white py-5 font-normal leading-8 mx-8 mt-6 ">
            Our focus stays on walking hand in hand with brands and leaders of
            tomorrow to build their influence and deliver meaningful impact
            across their worlds of business.
          </p>
      ...
      <section className=" px-5 lg:px-20 pt-64">
        <div className=" px-0 lg:px-16">
          <h1 className="text-center text-3xl lg:text-[56px] font-bold text-custom-header lg:leading-[73.9px]">
            Our tool box is a Swiss Army Knife and more
          </h1>
          <p className="text-center text-base lg:text-xl text-custom-lightgray py-5 font-normal lg:leading-8 lg:mx-[149.5px] mt-6 ">
            We distill and transfom your communication needs into opportunities
            to build/unlock your impact and influence. Our expertise covers:
          </p>
        </div>

        <div className="">
          {cardInformation.map((card, index) => (
            <div key={index} className="lg:px-0 px-6 ">
              <div
              ...
              >
                ...
                <div className="w-full lg:w-1/2 text-[10px] flex flex-col lg:gap-4">
        ...
        <Card className="space-y-10 bg-custom-black  text-white lg:max-h-[680px] pt-[103px] pb-[215px] lg:px-[64px]  items-center lg:mt-[455px]">
          <CardContent className="items-center flex flex-col space-y-8 ">
            <h1 className="font-black text-2xl lg:text-[56px]">
              Let's work together
            </h1>

            <Link href={""}>
              <Button className="bg-transparent hover:bg-transparent px-16 py-[14px] text-white rounded-lg shadow-none">
                View All
              </Button>
            </Link>
          </CardContent>
